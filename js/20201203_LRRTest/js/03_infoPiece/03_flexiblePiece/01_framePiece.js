...
function FramePiece(dom, init_width, init_height, init_color) {
    ...
    dom.framePiece.redraw = function () {
        ...
        //console.log('.framePiece.childDOMs.text.style[width,height,fontSize]: [' + dom.framePiece.childDOMs.text.style.width + ', ' + dom.framePiece.childDOMs.text.style.height + ', ' + dom.framePiece.childDOMs.text.style.fontSize);
        var applyFontSize = getFontSizeApply2Area(dom.framePiece.childDOMs.text);
        /*
        if (applyFontSize > dom.framePiece.data.maxFontSize) {
            applyFontSize = dom.framePiece.data.maxFontSize;
        }
        */
    ...
    dom.framePiece.remove = function () {
        //console.log('.framePiece.remove(): called.')
