...
function AreaCreateFP(moveAreaDOM, fPResizeFrameLineWidth) {
    ...
    moveAreaDOM.areaCreateFP.mousedownEventFunc = function (e) {
        //console.log('moveAreaDOM.areaCreateFP.mousedownEventFunc(): called.')
        ...
        //console.log('moveAreaDOM.moveAreaDOM.getPage(x,y): ' + moveAreaDOM.moveAreaDOM.getPageX(e) + ',' + moveAreaDOM.moveAreaDOM.getPageY(e));
        ...
        //fP.framePiece.moveCoordinate(moveAreaDOM.moveAreaDOM.getPageX(e), moveAreaDOM.moveAreaDOM.getPageY(e));
        ...
        //fP.fP.childDOMs.corner.rightBottom.mousedownEventFunc(e);
    ...
    moveAreaDOM.areaCreateFP.restoreInfoList = function(list) {
        console.log('.areaCreateFP.restoreInfoList(): called.')
        var styleObjFramePiece = {
            position: 'absolute',
            opacity: 0.5,
        }
