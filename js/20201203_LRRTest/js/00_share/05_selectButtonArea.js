function SelectButtonArea(dom, init_width, init_height, init_button_quantity_per_line, buttonTextList) {
    ...
    dom.selectButtonArea.redraw = function() {
        ...
        //console.log('.selectButtonArea.data.button_width: ' + dom.selectButtonArea.data.button_width);
        ...
        //console.log('.selectButtonArea.styleObj.button.width: ' + dom.selectButtonArea.styleObj.button.width);
