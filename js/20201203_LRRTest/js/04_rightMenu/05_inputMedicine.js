function InputMedicine(dom, initWidth, initHeight) {
    ...
    dom.inputMedicine.getValues = function() {
        return {
            ...
            comment: dom.inputMedicine.childDOMs.comment.ntagg.getValues(),
        }
    }
    dom.inputMedicine.setValues = function(values) {
        ...
        dom.inputMedicine.childDOMs.comment.ntagg.setText(values.comment);
    }
    ...
    new NoTextAreaGrayGuide(dom.inputMedicine.childDOMs.comment, 'コメントを入力', commentInitWidth, initHeight);
